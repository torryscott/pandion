...
tokens-check toolbar-labels-check toolbar-scroll-cue-check tour-check typing-check units-check void-honesty-check wizard-parity-check variable-levels-check visuals-check \
