...
view-zoom-drag-check inline-editor-zoom-check fit-wobble-check picker-hold-check scroll-anchor-check toolbar-redock-check stats-width-check reserve-rearm-check help-dock-route-check aspect-lock-check editor-focus-check category-spacing-check notebook-copy-check axis-role-labels-check open-by-link-check find-open-data-check mode-stat-check tours-check \
