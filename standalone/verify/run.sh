...
data-papercuts-check data-disclosure-check grid-wide-perf-check \
...
tokens-check toolbar-labels-check tour-check typing-check units-check void-honesty-check wizard-parity-check variable-levels-check visuals-check \
