...
view-zoom-drag-check inline-editor-zoom-check fit-wobble-check picker-hold-check scroll-anchor-check toolbar-redock-check stats-width-check reserve-rearm-check help-dock-route-check aspect-lock-check editor-focus-check category-spacing-check notebook-copy-check axis-role-labels-check mode-stat-check \
...
tokens-check toolbar-labels-check toolbar-scroll-cue-check typing-check units-check update-check void-honesty-check wizard-parity-check variable-levels-check visuals-check \
