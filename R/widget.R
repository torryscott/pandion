...
graphbuilder2_html <- function(bars,
                              ...
                              xy_y_nominal = NULL,
                               ...
                               custom_palette = "#2d5c94,#902634,#e18e4c,#597b2f,#faca59,#32295e,#5bb1ba,#d35a80",
                               chart_border = "none",
                               chart_grid = "none",
    ...
    payload <- list(
        ...
        chartFontScale = as.numeric(chart_font_scale),
        ...
        lineCategorySpacing = as.numeric(line_category_spacing),
