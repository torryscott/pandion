...
| 35.2 | | Add a significance bracket; drag each end onto a teal bar. As in the app, a leg that snaps to a bar center shows the pink guide and drops to sit just above that bar (10 px over its error bar), and the label computes to `***`. | Add a significance bracket, / then drag its ends onto two bars. / It runs the test for you. | Pop, snaps, chime. |
...
Axis and legend titles are in Title Case ("Condition", "Test Score",
"Site"), as APA style asks.
